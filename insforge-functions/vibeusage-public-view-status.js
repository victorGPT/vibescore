...
var require_vibescore_public_view_status = __commonJS({
  "insforge-src/functions/vibescore-public-view-status.js"(exports2, module2) {
    "use strict";
    ...
    module2.exports = withRequestLogging("vibescore-public-view-status", async function(request) {
...
module.exports = require_vibescore_public_view_status();
